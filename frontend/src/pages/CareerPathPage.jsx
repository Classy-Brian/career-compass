...
const surveySteps = [
  ...
  {
    step: 2,
    question: "On a scale of 1-5, where would you place yourself?",
    name: "socialScale",
    type: "scale",
    min: 1,
    max: 5,
      ...
      return (
        <div className="scale-input">
          ...
          <input
            ...
            value={answers[currentQuestion.name] || currentQuestion.min}
            onChange={handleChange}
            className="slider"
          />
          <span>{currentQuestion.maxLabel}</span>
          <p>Your selection: {answers[currentQuestion.name] || 'Not selected'}</p>
        </div>
      );
    }
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          ...
          {renderInput()} {/* Call the helper function here */}
        </div>
